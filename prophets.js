var prophetsData = {
    "prophets": [
      ...
      },
      {
        ...
        "numofchildren": 34,
        "imageurl": "https://www.josephsmithpapers.org/bc-jsp/content/jsp/images/content/library/images/450x600/A1-Page-644b-Taylor-John-PH-100-it-43.jpg"
      },
      {
        "name": "Wilford",
        "lastname": "Woodruff",
  ...
  function createProphetCards() {
    ...
    prophetsData.prophets.forEach(function(prophet) {
      ...
      death.textContent = "Death: " + (prophet.death ? prophet.death : "Present");
      ...
      var numofchildren = document.createElement("p");
